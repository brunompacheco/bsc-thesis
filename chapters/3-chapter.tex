...
It can be seen as penalizing the more complex features extracted by the model, in an effort of approximating the training data with the simplest model possible \cite{goodfellow_deep_2016}.
