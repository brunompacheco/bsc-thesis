...
Adam[REFTO Kingma, 2015] combined two impactful implementations [REFTO Duchi, 2011; Tieleman\_Hinton, 2012], encompassing both adaptive learning rates and momentum and taking them one step further.
...
The strategies designed to improve performance outside of the data seen during training at the cost of decreased performance in the training data are known as \emph{regularization} [REFTO goodfellow, 2016].
