...
The results are shown in figure XXX.  % TODO make jac regularization figure
The experiments showed that training without the regularization is ineffective, not achieving a satisfactory result within the training budget and taking much longer to train (XXX ms per epoch).  % TODO get training time for each epoch
