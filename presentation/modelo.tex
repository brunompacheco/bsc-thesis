...
\usepackage[backend=biber,style=abnt,repeatfields,maxbibnames=9,maxcitenames=3,uniquelist=false, uniquename=full,extrayear]{biblatex}
...
\begin{frame}
    ...
    \begin{itemize}
	\item Weight of the Jacobian regularization term ($\kappa$);
	\item Root-finding algorithm used in the forward pass;
	\item Tolerance of the root-finding algorithms.
    \end{itemize}
